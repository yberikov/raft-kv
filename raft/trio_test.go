...
func TestTrioRepairsDivergedFollower(t *testing.T) {
	...
	leader.log = append(leader.log, Entry{Cmd: Command{Key: "a"}, Term: 5}, Entry{Cmd: Command{Key: "b"}, Term: 5})
	for _, id := range d.ids {
	...
	follower.log = append(follower.log, Entry{Cmd: Command{Key: "x"}, Term: 3}, Entry{Cmd: Command{Key: "y"}, Term: 3}, Entry{Cmd: Command{Key: "z"}, Term: 4})
	...
	d.nodes[3].log = append(d.nodes[3].log, Entry{Cmd: Command{Key: "a"}, Term: 5}, Entry{Cmd: Command{Key: "b"}, Term: 5})
